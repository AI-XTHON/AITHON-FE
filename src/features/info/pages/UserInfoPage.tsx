...
export default function UserInfoPage({
    ...
    const handleSubmit = useCallback(() => {
        ...
        onSubmit?.({
            ...
            nickname: mode === "edit" ? state.nickname : undefined,
        });
    }, [isValid, onSubmit, state, mode]);
            ...
            <main className="flex-1 px-8 py-5 space-y-20 ">
                ...
                <section className=" relative space-y-3">
                    ...
                    <img src={msg} alt="" className="h-18" />
                        <p className="text-xs absolute left-5 top-14"><span className="text-[#F15A24]">복수 응답</span> 여러개 골라주세요!</p>
                    <MultiSelectChips
                        options={PURPOSES}
